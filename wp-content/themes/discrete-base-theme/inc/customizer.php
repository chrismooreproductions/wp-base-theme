<?php
/**
 * discrete-base-theme Theme Customizer
 *
...
function discrete_base_theme_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'discrete_base_theme_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'discrete_base_theme_customize_partial_blogdescription',
		) );
	}
}
 ...
 * @return void
 */
function discrete_base_theme_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function discrete_base_theme_customize_partial_blogdescription() {
